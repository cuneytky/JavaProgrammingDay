...
public class Restaurant {
    ...
    public ArrayList<Server> arrayList = new ArrayList<>();
    public ArrayList<Chef> chefArrayList= new ArrayList<>();
    ...
    public void terminateChef(int employeeID){
        chefArrayList.removeIf(p->p.employeeID== employeeID);
    }
    public void terminateServer(int employeeID){
        arrayList.removeIf(p->p.employeeID==employeeID);
    }
    ...
    public String toString() {
        return "Restaurant{" +
                ...
                ", numberOfServers=" + arrayList.size() +
                ", numberOfChefs=" + chefArrayList.size() +
                '}';
    }
}
/*
