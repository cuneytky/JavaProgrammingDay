...
public class ArraysUtility {
    ...
    public static boolean contains(int[] array, int element){
        ...
        for (int each : array) {
            if(each==element){ // if any array's element is matching with the given
                result = true;  //element, it means the given elements is contained in the array
            }
        }
        return result;
    }
    ...
    // returns the frequency of the given from the given array
