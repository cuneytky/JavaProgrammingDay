...
public class MapPractice2 {
    public static void main(String[] args) {
        ...
        //  maximum and minimum salary?--ben ekledim bu soruyu
/*
...
*/
        //1.1-1.2   who has the maximum and minimum salary?
        String name1 = "";
        int maxSalary = Integer.MIN_VALUE;
        ...
        for (Map.Entry<String, Integer> pair : map.entrySet()) {
            if( pair.getValue() < 118000){
                System.out.println(pair.getKey());// Antony Jimmy James Conor Josh
            }
        }
