...
import day54_FullReview.java_ecommerce_project.src.order.Order;
import day54_FullReview.java_ecommerce_project.src.order.OrderService;
import day54_FullReview.java_ecommerce_project.src.order.OrderServiceImpl;
...
import static day54_FullReview.java_ecommerce_project.src.StaticConstants.DISCOUNT_LIST;
import static day54_FullReview.java_ecommerce_project.src.StaticConstants.ORDER_LIST;
...
public class Main {
            ...
            switch (menuSelection){
                ...
                case 1:  // list product  // product name, product category name
                    try {
                        ...
                        System.out.println("Product could not printed because catecory not found for product name: "+e.getMessage().split(",")[1]);
                    }
                    break;
                case 2:  // list discount
                    for (Discount discount: DISCOUNT_LIST){
                        System.out.println("Discount Name: "+discount.getName()+" discount treshold amount: "+discount.getThresholdAmount());
                    }
                    break;
                case 3:  // See Balance
    ...
    private static GiftCardBalance findGiftCardBalance(UUID customerId){
        ...
        GiftCardBalance giftCarBalance = new GiftCardBalance(customerId,0d); // burasını DB eklememız gerekıyordu
        StaticConstants.GIFT_CARD_BALANCE_LIST.add(giftCarBalance);                // ekledık
