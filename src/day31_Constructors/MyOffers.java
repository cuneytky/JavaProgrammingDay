    ...
    public static void main(String[] args) {
        ...
        offer1.setInfo("VA","Amazon","SDET",
                  110000, true,true,true,true);
                                  //  data girdik...
        System.out.println(offer1); //Offer{location='VA', companyName='Amazon', jobTitle='SDET', salary=110000.0, hasBenefit=true, hasPTO=true, isWFH=true, isFullTime=true}
