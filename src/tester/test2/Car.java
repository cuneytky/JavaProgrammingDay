...
Create two concrete classes that extend the Vehicle class: "Car" and "Motorcycle".
 Implement the abstract methods in each class as follows:
...
Finally, write a main method in a separate class to test the functionality of the
Car and Motorcycle classes. Create instances of each class and call
the "start()", "stop()", and "accelerate()" methods on the objects.
